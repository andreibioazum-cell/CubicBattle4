 ...
 *
 * Файлы лежат в game/sounds (в APK — assets/sounds, в Windows-сборке —
 * RCDATA-ресурсы с именем "sounds/<файл>"). Поддерживается несжатый PCM WAV
...
/* ------------------------------------------------------------------ */
/* чтение файла звука: Android — ассеты, Windows — RCDATA-ресурс,       */
/* затем файловая система (папка sounds рядом с exe или в репозитории)  */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* жизненный цикл: вызывается из main.c / main_win32.c                 */
/* ------------------------------------------------------------------ */
