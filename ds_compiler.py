...
BUILTINS = frozenset({
    ...
    'net_load_ebuc_levels_unlocked', 'net_load_ordinary_prime_level',
    'net_load_azum_prime_level', 'net_load_santa_prime_level',
    'net_save_progress', 'net_save_progress_all', 'net_load_achievement_welcome',
    'net_load_achievement_all_characters', 'net_save_achievements', 'keyboard_show',
