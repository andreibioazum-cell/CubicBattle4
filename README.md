...
- Аккаунт в настройках: уникальный ник + пароль; ник показывается над своим персонажем и другими игроками. Пароль хранится только как salted PBKDF2-проверка, а занятый ник нельзя открыть с другим паролем
